...
// create an array of strings that combine the company's catchPhrase and bs
  const companyCombos = data.map(user => `${user.company.catchPhrase} - ${user.company.bs}`);
console.log(companyCombos);
//create an array of object that contain  the company's catchPhrase and bs
const phrase =data.map(user => {
  return{
